...
let showNav=true;function addOrRemoveLeftRightNavBtn(add){if(add){if(!showNav){$('.navbar-nav-btn-right').show();$('.navbar-nav-btn-left').show();showNav=true;}}else{if(showNav){$('.navbar-nav-btn-right').hide();$('.navbar-nav-btn-left').hide();showNav=false;}}}
