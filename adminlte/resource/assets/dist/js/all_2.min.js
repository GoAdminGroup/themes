...
removeActive();let addElement=$('<li class="active">\n'+
'<a href="'+link+'">\n'+
...
li.remove();});addElement.on('mouseover',function(){if($(this).children('i')){$(this).children('i').show();}});addElement.on('mouseout',function(){if($(this).children('i')){$(this).children('i').hide();}});addElement.on('click',function(){removeActive();$(this).addClass('active');});addElement.appendTo('.nav-addtabs');}});function checkNavExist(link){let navs=$('.nav-addtabs li');for(let i=0;i<navs.length;i++){if($(navs[i]).find('a').attr('href')===link){removeActive();$(navs[i]).addClass('active');return true;}}
return false;}
