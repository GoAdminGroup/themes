...
moveToRight();}});$('a.new-tab-link').on('click',function(){listenerForAddNavTab($(this).attr('href'),$(this).attr('data-title'))});$('.navbar-nav-btn-left').on('click',function(){let nav=$(".nav.nav-tabs.nav-addtabs");let marginLeft=parseInt(nav.css("marginLeft"));if(marginLeft<0){if(marginLeft<-50&&marginLeft>-100){nav.css("marginLeft","0px");}else{nav.css("marginLeft",(marginLeft+50)+"px");}}});$('.navbar-nav-btn-right').on('click',function(){moveToRight();});function moveToRight(){let nav=$(".nav.nav-tabs.nav-addtabs");let marginLeft=parseInt(nav.css("margin-left"));let ulWidth=getNavULwidth();let padding=ulWidth-maxNavWrapperWidth;console.log('moveToRight','ulWidth',ulWidth,'maxNavWrapperWidth',maxNavWrapperWidth,'padding',padding)
if(padding>0&&marginLeft+padding!=0){if(padding+marginLeft<100){nav.css("margin-left",-padding+"px");}else{nav.css("margin-left",(marginLeft-50)+"px");}}}
let showNav=true;function addOrRemoveLeftRightNavBtn(add){console.log("addOrRemoveLeftRightNavBtn","add",add,"showNav",showNav)
if(add){if(!showNav){$('.navbar-nav-btn-right').show();$('.navbar-nav-btn-left').show();showNav=true;}}else{if(showNav){$('.navbar-nav-btn-right').hide();$('.navbar-nav-btn-left').hide();showNav=false;}}}
...
li.remove();addOrRemoveLeftRightNavBtn(!checkNavLength())});addElement.on('mouseover',function(){if($(this).children('i')){$(this).children('i').show();}});addElement.on('mouseout',function(){if($(this).children('i')){$(this).children('i').hide();}});addElement.on('click',function(){removeActive();$(this).addClass('active');});addElement.appendTo('.nav-addtabs');}
...
let maxNavWrapperWidth=0;function initMaxNavWrapperWidth(){let navWidth=$('#firstnav').width();let menuWidth=$('.navbar-custom-menu').width();console.log('initMaxNavWrapperWidth','navWidth',navWidth,'menuWidth',menuWidth)
...
function checkNavLength(){let ulWidth=getNavULwidth();console.log('checkNavLength',"wrapperWidth",maxNavWrapperWidth,"ulWidth",ulWidth);return ulWidth+50<maxNavWrapperWidth;}
